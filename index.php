...
<html class="no-js" lang="">
    <head>
        ...
        <title>Iskander Alymov - Portfolio</title>
    ...
    <body>
		...
		<!-- Slider Area -->
		<section id="slider" class="slider" style="background-image:url('img/KK.jpg')">
			<div class="container">
				<div class="row">
					<div class="col-md-7 col-sm-12 col-xs-12">
						<div class="text">
							<h1>Hi,my name is Iskander</h1>
							<p>My full name is Iskander Alymov, I'm 17 and I'm learning in International Ala-Too University's college, on Software Development specialty. </p>
							<div class="button">
							...
							<div class="single-about">
								...
								<div class="social">
									<ul>
										...
										<li><a href="https://www.instagram.com/htk_is/"><i class="fa fa-instagram"></i></a></li>
										<li><a href="https://www.pinterest.ru/iskaalymov/_saved/"><i class="fa fa-pinterest-p"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
									...
									<div class="skill-main">
										<div class="single-skill">
											...
											<div class="progress two">
												<div class="progress-bar" data-percent="45">
													<span>45%</span>
												</div>
											</div>
										</div>
					...
					<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
						<div class="story-content">
							...
							<div class="single-story">
								<span class="year wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.4s">2017</span>
							...
							<!-- single-story -->
							<div class="single-story">
								<span class="year wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.8s">2020</span>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="contact-info">
							...
							<span><i class="fa fa-phone-square"></i>+996 ### ## ## ##</span>
							<span><i class="fa fa-map-marker"></i>Kyrgyzstan, Bishkek, 5th microdistrict</span>
							<span><i class="fa fa-envelope"></i><a href="#">######@gmail.com</a></span>
							<span><i class="fa fa-globe"></i><a href="#">www.#########.com</a></span>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="social">
								...
								<li><a href="https://www.instagram.com/htk_is/"><span class="fa fa-instagram"></span></a></li>
								<li><a href="https://www.pinterest.ru/iskaalymov/_saved/"><span class="fa fa-pinterest-p"></span></a></li>
							</ul>
							<!-- End Social -->
						</div>
					</div>
